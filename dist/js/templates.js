...
; html += '' 
; html += '    <button class="btn btn-primary back-to-btn" spike-unbinded spike-event-click="app.router.back();" spike-translation="back_to_post"></button>' 
; html += '' 
; html += '    <h2 spike-translation="comments_list"></h2>' 
...
; window['_spike_templates']['@template/post'] =  '<div id="postContent">' + 
 ...
 '    <a href="" id="comments" spike-translation="post_comments"></a>' + 
...
; html += '<div class="post">' 
; html += '' 
; html += '    <button class="btn btn-primary back-to-btn" id="backToList" spike-translation="back_to_list"></button>' 
; html += '' 
; html += '    @template(post)' 
; html += '' 
; html += '</div>' 
...
; html += '' 
; html += '    <h2 spike-translation="posts_list"></h2>' 
...
; html += '' 
; html += '    <button class="btn btn-primary back-to-btn" id="backToPost" spike-translation="back_to_post"></button>' 
; html += '' 
; html += '    <h2 spike-translation="edit_post"></h2>' 
; html += '' 
; html += '    <form class="form-horizontal" id="postForm">' 
; html += '        <fieldset>' 
; html += '' 
; html += '            <div class="form-group">' 
; html += '                <label class="control-label" for="title" spike-translation="post_title"></label>' 
...
; html += '' 
; html += '            <div class="form-group">' 
; html += '                <label class="control-label" for="body" spike-translation="post_content"></label>' 
; html += '                <div class="col-md-12">' 
...
; html += '                    <button id="save" name="button1id" class="btn btn-success" spike-translation="save"></button>' 
; html += '                    <button id="delete" name="button2id" class="btn btn-danger" spike-translation="delete"></button>' 
; html += '                </div>' 
; html += '            </div>' 
; html += '' 
; html += '        </fieldset>' 
...
; html += '' 
; html += '    <h2 spike-translation="about"></h2>' 
; html += '    <p spike-translation="about_text"></p>' 
; html += '' 
; html += '</div>' 
; html += '' 
; return html 
...
; html += '<div class="home">' 
; html += '' 
; html += '    <h2 spike-translation="home" id="home"></h2>' 
; html += '    <p spike-translation="recent_posts"></p>' 
; html += '' 
; html += '    <component name="postsList"></component>' 
; html += '</div>' 
; html += '' 
...
; html += '                <p class="title" spike-translation="delete_title"></p>' 
; html += '                <p class="question" spike-translation="confirm_delete_post_question"></p>' 
; html += '' 
; html += '                <button class="btn btn-danger" id="close" spike-translation="close"></button>' 
; html += '                <button class="btn btn-primary" id="ok" spike-translation="ok"></button>' 
; html += '            </div>' 
; html += '' 
; html += '        </div>' 
; html += '    </div>' 
...
; html += '    <p spike-translation="page_not_found"></p>' 
; html += '</div>' 
; return html 
; } 
...
; html += '' 
; html += '        <li class="left">' 
; html += '            <span spike-translation="menu"></span>' 
; html += '            <span id="currentLang" spike-translation="language_en"></span>' 
; html += '        </li>' 
; html += '' 
...
; html += '' 
; html += '        <li id="home"><a href="#/" spike-translation="menu_home"></a></li>' 
; html += '        <li id="posts"><a href="#/posts" spike-translation="menu_posts"></a></li>' 
; html += '        <li id="about"><a href="#/about" spike-translation="menu_about"></a></li>' 
; html += '        <li class="language">' 
; html += '            <button type="button" class="btn btn-default" id="changeLangToEn" spike-translation="language_en"></button>' 
; html += '            <button type="button" class="btn btn-default" id="changeLangToPl" spike-translation="language_pl"></button>' 
; html += '        </li>' 
; html += '' 
; html += '    </ul>' 
; html += '' 
